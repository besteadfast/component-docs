<template>
  ...
  >
    <summary
      style="margin: 0px"
      class="flex justify-between items-center w-full px-s4 py-s2 bg-transparent interact:bg-teal-100 interact:outline-none transition duration-300 hover:cursor-pointer"
      ref="accButtonRef"
    >
      <slot name="button">
        Accordion Title
    ...
    <div class="max-h-0 transition-all overflow-hidden" ref="accPanelRef">
      <slot name="content">
